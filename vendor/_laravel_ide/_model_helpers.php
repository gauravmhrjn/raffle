...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Address>|Address whereStreet($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Address>|Address whereCountryCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Address>|Address whereContactNumber($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Address>|Address ofUserId(int $userId) {@see App\Models\Address::ofUserId()}
     ...
     * @property integer $user_id
     * @property integer $raffle_entry_id
     ...
     * @property-read \App\Models\RaffleEntry $raffleEntry
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order wherePaymentTransactionCode($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order whereRaffleEntryId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order forUser(\App\Models\User $user) {@see App\Models\Order::forUser()}
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order forProduct(\App\Models\Product $product) {@see App\Models\Order::forProduct()}
     * @method static \Illuminate\Database\Eloquent\Builder<Order>|Order forRaffleEntry(\App\Models\RaffleEntry $raffleEntry) {@see App\Models\Order::forRaffleEntry()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon $raffle_date
     * @property integer $qty
     * @property float $price
     * @property string|null $description
     * @property \Illuminate\Database\Eloquent\Casts\AsUri $image_url
     * @property string $name
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereRaffleDate($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product active() {@see App\Models\Product::active()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product inactive() {@see App\Models\Product::inactive()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product raffled() {@see App\Models\Product::raffled()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product forSlug(string $slug) {@see App\Models\Product::forSlug()}
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product toRaffle() {@see App\Models\Product::toRaffle()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property mixed $encrypted_payment_token
     * @property integer $product_id
     * @property integer $address_id
     * @property integer $user_id
     * @property mixed $status
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereEntryCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereAddressId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry whereEncryptedPaymentToken($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry forUser(\App\Models\User $user) {@see App\Models\RaffleEntry::forUser()}
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry forProduct(\App\Models\Product $product) {@see App\Models\RaffleEntry::forProduct()}
     * @method static \Illuminate\Database\Eloquent\Builder<RaffleEntry>|RaffleEntry pending() {@see App\Models\RaffleEntry::pending()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
